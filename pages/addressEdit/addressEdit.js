...
Page({
  ...
  save: function () {
    ...
    var xinxi = {
      uid: userId,
      id: this.data.id1,
      name: this.data.people1,
      phone: this.data.phone1,
      province: this.data.province,
      city: this.data.city,
      area: this.data.county,
      address: this.data.detail1,
      is_default: this.data.kai1
    }
    api._post('/api/address/store', xinxi).then(res => {
      console.log(res)
      if (res.status == true) {
        wx.navigateBack({
          delta: 1,
